// Package workflowhelp holds the canonical multi-lane workflow, printed
// by `hcode workflow-help` and mirrored into README.md's "Workflow"
// section — keep both in sync when this changes.
package workflowhelp

// Text is the full walkthrough.
const Text = `A multi-lane Claude Code workflow on one box: one orchestrator lane plus
